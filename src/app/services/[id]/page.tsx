...
export default function ServiceDetailPage() {
  ...
  // Get features — iterate until first missing key
  const features = [];
  for (let i = 1; i <= 10; i++) {
    const featureKey = `service-${keyPrefix}-f${i}`;
    const translatedFeature = t(featureKey);
    if (translatedFeature === featureKey) break;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-900 to-blue-800 text-white py-12 sm:py-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          {/* Sidebar/CTA */}
          <div className="bg-white rounded-xl shadow-md p-6 sm:p-8 h-fit">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">
              {t("service-get-started-title")}
            </h3>
