    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>
            <strong>Power Distribution & Transmission Substations Design:</strong>
