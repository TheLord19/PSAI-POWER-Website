...
import { ShieldCheck, Award, HardHat, Globe, Zap } from "lucide-react";
...
export default function LicensesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Breadcrumbs items={[{ label: t("licenses") }]} />
            ...
            {[
              {
                ...
                logoContent: (
                  <div className="flex flex-col items-center justify-center w-full h-full">
                    ...
                    <span className="text-[9px] font-semibold text-blue-200 tracking-widest uppercase mt-0.5 text-center leading-tight">
                      Engineers
                      <br />
                      Ontario
                    </span>
              ...
              },
              {
                ...
                logoContent: (
                  <div className="flex flex-col items-center justify-center w-full h-full">
                    ...
                    <span className="text-[9px] font-semibold text-orange-100 tracking-widest uppercase mt-0.5 text-center leading-tight">
                      {"Safety & Insurance"}
                    </span>
                  </div>
                ),
              },
              {
                ...
                logoContent: (
                  <div className="flex flex-col items-center justify-center w-full h-full">
                    ...
                    <span className="text-[9px] font-semibold text-indigo-200 tracking-widest uppercase mt-0.5 text-center leading-tight">
                      Engineers
                      <br />
                      Geosci. MB
                    </span>
              ...
              },
              {
                ...
                logoContent: (
                  <div className="flex flex-col items-center justify-center w-full h-full">
                    ...
                    <span className="text-[8px] font-semibold text-blue-200 tracking-wider uppercase mt-0.5 text-center leading-tight">
              ...
              <div
                key={license.id}
                className="group bg-white rounded-2xl p-8 border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden"
              >
                <div
                  className={`absolute top-0 right-0 w-32 h-32 bg-${license.color}-50 rounded-bl-full -mr-16 -mt-16 transition-transform group-hover:scale-150 duration-500`}
                ></div>

                <div className="relative z-10">
                  <div
                    className={`w-20 h-20 ${license.logoBg} rounded-2xl flex items-center justify-center mb-6 group-hover:shadow-md transition-all overflow-hidden`}
                  >
                    {license.logoContent}
                  </div>
