      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            {t("wws-industry-not-found")}
          </h1>
          <Link href="/who-we-serve" className="text-blue-600 hover:underline">
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-blue-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          <Link
            href="/who-we-serve"
            className="text-blue-200 hover:text-white mb-6 inline-block"
          >
            ← {t("wws-back-to-industries")}
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {t(`wws-${keyPrefix}-title`)}
          </h1>
          <p className="text-xl text-blue-100 max-w-3xl">
            {t(`wws-${keyPrefix}-desc`)}
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            {projects.length > 0 && (
              <>
                <h3 className="text-xl font-semibold text-gray-900 mb-6">
                  {t("wws-projects-title")}
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {projects.map((project: string, index: number) => (
                    <div key={index} className="bg-blue-50 rounded-lg p-4">
                      <p className="text-blue-800 font-medium">{project}</p>
                    </div>
                  ))}
                </div>
              </>
          ...
          <div className="bg-white rounded-xl shadow-md p-8 h-fit">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">
              {t("wws-get-started-title")}
            </h3>
            <p className="text-gray-600 mb-6">{t("wws-get-started-desc")}</p>
            <Link
              href="/contact-us"
